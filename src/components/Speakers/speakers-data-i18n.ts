...
import MiduImage from "@img/speakers/Midu-x64.avif";
import MiduRealImage from "@img/speakers/Midu-real.avif";
import SamuelImage from "@img/speakers/Samuel-x64.avif";
import SamuelRealImage from "@img/speakers/Samuel-real.avif";
import AlmudenaImage from "@img/speakers/Almudena-x64.avif";
import AlmudenaRealImage from "@img/speakers/Almudena-real.avif";
import BorjaImage from "@img/speakers/Borja-x64.avif";
import BorjaRealImage from "@img/speakers/Borja-real.avif";
import AntonioImage from "@img/speakers/Antonio-x64.avif";
import AntonioRealImage from "@img/speakers/Antonio-real.avif";
import PilarImage from "@img/speakers/Pilar-x64.avif";
import PilarRealImage from "@img/speakers/Pilar-real.avif";
import CristinaImage from "@img/speakers/Cristina-x64.avif";
import CristinaRealImage from "@img/speakers/Cristina-real.avif";
import DiegoImage from "@img/speakers/Diego-x64.avif";
import DiegoRealImage from "@img/speakers/Diego-real.avif";
import NachoImage from "@img/speakers/Nacho-x64.avif";
import NachoRealImage from "@img/speakers/Nacho-real.avif";
import NereaImage from "@img/speakers/Nerea-x64.avif";
import NereaRealImage from "@img/speakers/Nerea-real.avif";
import EvaImage from "@img/speakers/Eva-x64.avif";
import EvaRealImage from "@img/speakers/Eva-real.avif";
import BraisImage from "@img/speakers/Brais-x64.avif";
import BraisRealImage from "@img/speakers/Brais-real.avif";
